...
|Ruby Science Foundation|使用Ruby语言的科学研究工具||
...
|Checker Framework|java|代码纠错系统|proposal要求明确，实现内容不是很有趣|
|Cloud Native Computing Foundation (CNCF)|golang|类Kubernetes、云计算、容器化|方向比较好、比较热门，组织真的很大很有名，可以冲一下|
